...
tag_this_file = f''' regr {SELECTED_AREA}1/54 {DELTA_T} {dataset_name} {selected_model}'''
print(f'==============================================')
...
# ----------------------------------------------------------------------------------------------------------------------
# ------------------------------------------------------ System --------------------------------------------------------
parser.add_argument('--gpu', type=int, default='5', help='GPU index, -1 for CPU')
...
if __name__ == '__main__':
    ...
    best_val_evaluator = SupervisedTrainer(best_model, val_loader, device, config['loss_module'],
                                            print_interval=config['print_interval'], console=config['console'],
                                            print_conf_mat=True)
    best_aggr_metrics_val, all_metrics = best_val_evaluator.evaluate(keep_all=True)
